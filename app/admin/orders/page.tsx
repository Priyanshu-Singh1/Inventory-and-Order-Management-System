  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-1">View all orders with buyer and seller details.</p>
      </div>
            ...
            <div key={order.id} className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
              <div className="bg-gray-50 dark:bg-gray-900/50 p-4 border-b border-gray-100 dark:border-gray-700 flex flex-wrap gap-4 justify-between items-center">
                <div>
                  ...
                  <div className="text-sm text-gray-500">Buyer: <span className="font-medium text-gray-700 dark:text-gray-300">{order.user.email}</span> &middot; {order.createdAt.toLocaleString()}</div>
                </div>
                  ...
                  <table className="w-full text-left text-sm">
                    <thead>
                      <tr className="border-b border-gray-200 dark:border-gray-700">
                        ...
                        <th className="pb-2 font-medium text-gray-500">Seller</th>
                    ...
                    <tbody>
                      {order.items.map(item => (
                        <tr key={item.id} className="border-b border-gray-100 dark:border-gray-800 last:border-0">
                          ...
                          <td className="py-3 text-gray-500">{item.product.seller.email}</td>
